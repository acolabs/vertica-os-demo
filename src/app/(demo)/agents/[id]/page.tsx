...
export default function AgentDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <DemoTooltip content="Sourced from the agents table (total_runs, total_decisions, total_value_created, accuracy_rate) and runs table (AVG duration_ms, SUM cost_usd) via /api/agents/{id}. Value Created = SUM of impact_dollars from approved decisions generated by this agent." side="right">
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="config" className="mt-4">
          <DemoTooltip content="Sourced from the agents table config JSON column via /api/agents/{id}. Stores model name, temperature, tool permissions, schedule, and integration scopes. Config changes create an audit_log entry for governance tracking." side="right">
        ...
        <TabsContent value="memory" className="mt-4">
          <DemoTooltip content="Agent memory is derived from historical decision outcomes stored in the decisions table. Patterns are extracted from approved/rejected decision pairs to refine future recommendations. Memory state is a read-only view of learned context." side="right">
