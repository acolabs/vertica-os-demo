...
const availableIntegrations: AvailableIntegration[] = [
  ...
  { name: "Intercom", type: "Support", icon: Headphones, color: "text-blue-400" },
        ...
        {availableIntegrations.map((integration) => {
          ...
          return (
            <Card
              ...
              className="border-[#1a1a24] bg-[#111118] opacity-60 hover:opacity-80 transition-opacity"
            >
              <CardHeader className="pb-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <Badge variant="secondary" className="text-[10px] mt-1 bg-zinc-800/50 text-zinc-500">
                      {integration.type}
                    </Badge>
                  </div>
                </div>
