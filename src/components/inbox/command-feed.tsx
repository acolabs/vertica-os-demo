        ...
        <div className="px-6 py-4">
          <Tabs defaultValue="evidence">
            ...
            <TabsContent value="evidence">
              <DemoTooltip
                content="Aggregated signals from multiple source systems. Each item links to the original record for verification."
                side="right"
              >
            ...
            <TabsContent value="actions">
              <DemoTooltip
                content="Agent-recommended actions with system-level specificity. All actions respect your governance policies."
                side="right"
              >
                <h4 className="text-xs font-medium text-[var(--text-muted)] uppercase tracking-wider mb-2">
                  Recommended Actions
            ...
            <TabsContent value="preview">
              <DemoTooltip
                content="Field-level preview of exactly what will change in each connected system. The 'blast radius' of this decision."
                side="right"
              >
                <h4 className="text-xs font-medium text-[var(--text-muted)] uppercase tracking-wider mb-2">
                  Action Preview
